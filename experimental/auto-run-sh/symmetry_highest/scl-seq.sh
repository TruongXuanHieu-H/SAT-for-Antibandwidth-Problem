...
$ENC_DIR/abw_enc $DATASET_DIR/E-bcsdw02.mtx.rnd     $ENC_TYPE -limit-real-time $TIME_LIMIT -limit-memory $MEMORY_LIMIT -symmetry-break $SYMMETRY_BREAK -process-count $WORKER_COUNT $ADD_CONFIGS 2>&1 | tee $LOG_DIR/E-bcsdw02.log
